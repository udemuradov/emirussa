...
require '/var/www/html/php/php-mailer/src/PHPMailer.php';
require '/var/www/html/php/php-mailer/src/SMTP.php';
require '/var/www/html/php/php-mailer/src/Exception.php';

// Step 1 - Enter your email address below.
$email = 'batly-gadam.website@mail.ru';
...
try {
	...
	$mail->Username = 'batly-gadam.website@mail.ru';                    // SMTP username
	$mail->Password = 'Pp2jiYurVegqJcyXG6U4';                              // SMTP password
